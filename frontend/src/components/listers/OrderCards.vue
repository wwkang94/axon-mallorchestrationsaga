<template>
    <div>
            ...
            <OrderStatusQuery @search="search"></OrderStatusQuery>
    ...
    export default {
        ...
        methods:{
            async search(query) {
                ...
                var temp = null;
                if(query!=null){
                    temp = await axios.get(axios.fixUrl('/orders/' + query.apiPath), {params: query.parameters})
                }else{
                    temp = await axios.get(axios.fixUrl('/orders'))
                }
