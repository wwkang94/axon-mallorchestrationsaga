<template>
    <div>
            ...
            <ProductListQuery @search="search"></ProductListQuery>
    ...
    export default {
        ...
        methods:{
            async search(query) {
                ...
                var temp = null;
                if(query!=null){
                    temp = await axios.get(axios.fixUrl('/products/' + query.apiPath), {params: query.parameters})
                }else{
                    temp = await axios.get(axios.fixUrl('/products'))
                }
